...
if(isset($_POST['Change'])) {
    ...
    $query = "UPDATE `goods` SET `Price`='" . $price . "' WHERE `ID_Code`=$id";
            ...
            <div class="card__details">
                <ul>
                    ...
                    <form action="price.php" method="post">
                        ...
                        <input type="text" name="price"required placeholder="New_Price"><br></br>
        ...
        <div class="card__side card__side--front">
            <div class="card__theme">
                <div class="card__theme-box">
                    <p class="card__subject">Price-Report</p>
                    <canvas id="myChart"></canvas>
                </div>
            </div>
        </div>
    ...
    function draw_pie() {
        ...
        chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: "Adv",
                    backgroundColor: 'rgb(202, 55, 130, 0.65)',
